...
/**
 * Tester for CS 2110 Homework 2 Fall 2013
 * 
...
public class HW2Tester {
	...
	private static TestCase testCases[] = {
			new TestCase("strdtoi", 654, "654", 2147483647, "2147483647", 0,
					"0", 555555555, "555555555"),

			new TestCase("strbtoi", 0, "0", 11, "1011", 72, "1001000",
					2147483647, "1111111111111111111111111111111"),

			new TestCase("strxtoi", 0, "0", 50, "32", 0xFEDCBA, "FEDCBA",
					0x7FFFFFFF, "7FFFFFFF"),

			new TestCase("itostrb", "0", 0, "1110", 14, "101010", 42,
					"1111111111111111111111111111111", 2147483647),

			new TestCase("itostrx", "0", 0, "10", 16, "FEED", 65261,
					"7FFFFFFF", 2147483647),

			new TestCase("setNibble", 0x0001, 0x0000, 0x1, 0, 0xFFF0, 0xFFFF,
					0x0, 0, 0xFF6F, 0xFFFF, 0x6, 1, 0x13E2, 0x1312, 0xE, 1,
					0x0800, 0x0000, 0x8, 2, 0x3291, 0x3391, 0x2, 2, 0x4234,
					0x1234, 0x4, 3, 0xBEEF, 0xDEEF, 0xB, 3),

			new TestCase("getShort", 0x0202, 0x10100202, 0, 0xBEEF, 0xDEADBEEF,
					0, 0xDEAD, 0xDEADBEEF, 1, 0x1234, 0x12345678, 1),

			new TestCase("pack", 0x1234, 0x1, 0x2, 0x3, 0x4, 0xBEEF, 0xB, 0xE,
					0xE, 0xF, 0xCAFE, 0xC, 0xA, 0xF, 0xE, 0xAAAA, 0xA, 0xA,
					0xA, 0xA),

			new TestCase("abs", 0x00002110, 0x00002110, 17, 0x00000DCA,
					0x00001236, 13, 0x3FFFFFFF, 0x3FFFFFFF, 31, 0x00000001,
					0x7FFFFFFF, 31),

			new TestCase("xor", 0xFFFFFFFF, 0xFF00FF00, 0x00FF00FF, 0x95511559,
					0x12345678, 0x87654321, 0xFFFFDDDD, 0x55555555, 0xAAAA8888,
					0x66666666, 0x55555555, 0x33333333),

			new TestCase("powerOf2", true, 0x10000000, false, 0x000000A0, true,
					0x00000008, false, 0x80000000, true, 0x00000001, false,
					0x12345678, false, 0x00000000),

			new TestCase("set", 0x00000000, 0x00000001, 0, 0x00000001,
					0x00000003, 1, 0x00000003, 0x00000007, 2, 0x00000007,
					0x0000000F, 3, 0x0000000F, 0x0000001F, 4, 0x0000001F,
					0x0000003F, 5, 0x0000003F, 0x0000007F, 6, 0x0000007F,
					0x000000FF, 7, 0x000000FF, 0x000001FF, 8, 0x000001FF,
					0x000003FF, 9, 0x000003FF, 0x000007FF, 10, 0x000007FF,
					0x00000FFF, 11, 0x00000FFF, 0x00001FFF, 12, 0x00001FFF,
					0x00003FFF, 13, 0x00003FFF, 0x00007FFF, 14, 0x00007FFF,
					0x0000FFFF, 15, 0x0000FFFF, 0x0001FFFF, 16, 0x0001FFFF,
					0x0003FFFF, 17, 0x0003FFFF, 0x0007FFFF, 18, 0x0007FFFF,
					0x000FFFFF, 19, 0x000FFFFF, 0x001FFFFF, 20, 0x001FFFFF,
					0x003FFFFF, 21, 0x003FFFFF, 0x007FFFFF, 22, 0x007FFFFF,
					0x00FFFFFF, 23, 0x00FFFFFF, 0x01FFFFFF, 24, 0x01FFFFFF,
					0x03FFFFFF, 25, 0x03FFFFFF, 0x07FFFFFF, 26, 0x07FFFFFF,
					0x0FFFFFFF, 27, 0x0FFFFFFF, 0x1FFFFFFF, 28, 0x1FFFFFFF,
					0x3FFFFFFF, 29, 0x3FFFFFFF, 0x7FFFFFFF, 30, 0x7FFFFFFF,
					0xFFFFFFFF, 31),

			new TestCase("clear", 0xFFFFFFFF, 0xFFF7FFFF, 19, 0xFFF7FFFF,
					0xFFD7FFFF, 21),

			new TestCase("toggle", 0xFFFFFFFF, 0xFFFFFFFE, 0, 0xFFFFFFFE,
					0xFFFFFFFF, 0, 0xABCDEFFF, 0xABCDFFFF, 12, 0xABCDEFFF,
					0xEBCDEFFF, 30),

			new TestCase("isSet", 0x00100000, true, 20, 0x55555555, true, 0,
					0x753A96CB, false, 31, 0xFFFFFFFF, false, 32),

			new TestCase("isClear", 0x00100000, false, 20, 0x55555555, false,
					0, 0x753A96CB, true, 31, 0xFFFFFFFF, true, 32),

			new TestCase("toString", 0x00000000,
					"00000000000000000000000000000000", 0xDEADBEEF,
					"11011110101011011011111011101111", 0x0000F569,
					"00000000000000001111010101101001", 0xFFFFFF0F,
					"11111111111111111111111100001111", 0xFFAF7FFF,
					"11111111101011110111111111111111"),

			new TestCase("onesCount", 0xFFFFFFFF, 32, 0x00000000, 0,
					0x5555FFFF, 24, 0x87654321, 13),

			new TestCase("zerosCount", 0xFFFFFFFF, 0, 0x00000000, 32,
					0x5555FFFF, 8, 0x87654321, 19),

			new TestCase("size", 0xFFFFFFF0, 32, 0x1F4CAB04, 29, 0x00000000, 1,
					0x00007569, 15) };
	 ...
	 * 
	 * @param name
	 *            The name of the function being tested by this test case.
	 * @param tests
	 *            The test data for this test case, specialized for each test.
	 * @param score
	 *            The score earned on the test, from 0.0 - 1.0 A value of -1.0
	...
	private static class TestCase {
		 ...
		 * 
		 * @param n
		 *            The weight of this test in raw points.
		 * @param s
		 *            The name of the function being tested.
		 * @param o
		 *            The data used for testing this function.
		 */
	 ...
	 * can busy block for a set period on each test and avoid infinite loops. If
	 * the code infinite loops, this will hang until System.exit(0) is reached
	 * in the end of main.
	 */
	private static class TestThread implements Runnable {
		 ...
		 * 
		 * @param id
		 *            The ID for which test this thread represents.
		 */
	 ...
	 * 
	 * @param pw
	 *            A PrintWriter which will write a detailed log to an output
	 *            file.
	 * @param t
	 *            A TestCase whose data will be used in this test.
	 */
	...
	private static void test_setNibble(TestCase t) {
		...
		for (int i = 0; i < t.tests.length; i += 4) {
			...
			pw.printf(
					"%s(%4X, %1X, %d): Expected: %4X Result: %4X Correct: %5b\n",
	...
	private static void test_pack(TestCase t) {
		...
		for (int i = 0; i < t.tests.length; i += 5) {
			...
			pw.printf(
					"%s(%1X, %1X, %1X, %1X): Expected: %4X Result: %4X Correct: %5b\n",
